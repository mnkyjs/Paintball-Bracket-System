...
export class PlanerService {
		...
		return this.http
			...
			.pipe(
				_observableCatch((response_: any) => {
					...
					} else return <Observable<AuthModelDto>>(<any>_observableThrow(response_));
				})
			);
	}
		...
		return this.http
			...
			.pipe(
				_observableCatch((response_: any) => {
					...
					} else return <Observable<FieldDto>>(<any>_observableThrow(response_));
				})
			);
	}
		...
		return this.http
			...
			.pipe(
				_observableCatch((response_: any) => {
					...
					} else return <Observable<Location>>(<any>_observableThrow(response_));
				})
			);
	}
		...
		return this.http
			...
			.pipe(
				_observableCatch((response_: any) => {
					...
					} else return <Observable<LocationDto[]>>(<any>_observableThrow(response_));
				})
			);
	}
		...
		return this.http
			...
			.pipe(
				_observableCatch((response_: any) => {
					...
					} else return <Observable<TeamDto[][]>>(<any>_observableThrow(response_));
				})
			);
	}
	...
	deleteMatch(time: Date, name: string | null): Observable<void> {
		...
		if (time === undefined || time === null) throw new Error("The parameter 'time' must be defined.");
	 ...
	 * @return Success
	 */
	getMatchesByDate(time: Date, name: string | null): Observable<BlockDto[]> {
		let url_ = this.baseUrl + '/api/Match/{time}/{name}';
		if (time === undefined || time === null) throw new Error("The parameter 'time' must be defined.");
		url_ = url_.replace('{time}', encodeURIComponent(time ? '' + time.toJSON() : 'null'));
		if (name === undefined || name === null) throw new Error("The parameter 'name' must be defined.");
		...
		return this.http
			...
			.pipe(
				_observableMergeMap((response_: any) => {
					return this.processGetMatchesByDate(response_);
				})
			)
			.pipe(
				_observableCatch((response_: any) => {
					if (response_ instanceof HttpResponseBase) {
						try {
							return this.processGetMatchesByDate(<any>response_);
						} catch (e) {
							return <Observable<BlockDto[]>>(<any>_observableThrow(e));
						}
					} else return <Observable<BlockDto[]>>(<any>_observableThrow(response_));
				})
			);
	}

	protected processGetMatchesByDate(response: HttpResponseBase): Observable<BlockDto[]> {
		const status = response.status;
		const responseBlob =
			response instanceof HttpResponse
				? response.body
	 ...
	 * @return Success
	 */
	getMatches(): Observable<BlockDto[]> {
		let url_ = this.baseUrl + '/api/Match/GetAllMatches';
		url_ = url_.replace(/[?&]$/, '');
	...
	protected processGetMatches(response: HttpResponseBase): Observable<BlockDto[]> {
		const status = response.status;
		const responseBlob =
			response instanceof HttpResponse
				? response.body
	...
	getByField(paintballfield: number | undefined): Observable<BlockDto[]> {
		...
		if (paintballfield === null) throw new Error("The parameter 'paintballfield' cannot be null.");
		else if (paintballfield !== undefined) url_ += 'paintballfield=' + encodeURIComponent('' + paintballfield) + '&';
		url_ = url_.replace(/[?&]$/, '');
		...
		return this.http
			...
			.pipe(
				_observableCatch((response_: any) => {
					...
					} else return <Observable<TeamPagedResult>>(<any>_observableThrow(response_));
				})
			);
	}
		...
		return this.http
			...
			.pipe(
				_observableCatch((response_: any) => {
					...
					} else return <Observable<KeyPairValueDto[]>>(<any>_observableThrow(response_));
				})
			);
	}
